...
export const ComponentBrowser: React.FC<ComponentBrowserProps> = ({ onComponentAdded }) => {
  ...
  return (
    <div className="component-browser flex flex-col h-full bg-gray-50 rounded-lg">
      {/* Tabs */}
      <div className="flex items-center border-b border-gray-200 bg-white p-2 rounded-t-lg">
        <button
      ...
      <div className="flex-1 overflow-y-auto p-3">
        ...
        {Object.entries(groupedComponents).map(([category, components]) => (
          <div key={category} className="mb-4">
            <div 
              className="flex items-center justify-between px-2 py-1 bg-gray-100 rounded-md mb-2 cursor-pointer"
            ...
            {expandedCategories[category] && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 flex-col pl-2">
