    ...
    resources: [
      {
        ...
        resolver: async () => {
          // In un'implementazione browser/client, useElementsStore funzionerebbe direttamente
          // Poiché siamo in un API route, simuliamo l'accesso agli elementi
          try {
            // Recupera dati da database o memoria
...
function getCADElements(): Element[] {
...
function getAvailableMaterials(): LocalMaterial[] {
...
function getElementTypesInfo() {
  ...
  return {
    ...
    'gear': {
      description: 'A gear component',
      properties: ['type', 'module', 'teeth', 'width', 'boreDiameter', 'x', 'y', 'z', 'color', 'material'],
      category: 'mechanical'
    },
    'spring': {
      description: 'A spring component',
      properties: ['diameter', 'wireSize', 'coils', 'length', 'x', 'y', 'z', 'color', 'material'],
      category: 'mechanical'
    },
    
    // Elementi di assemblaggio
    'screw': {
      description: 'A screw fastener',
      properties: ['type', 'diameter', 'length', 'threadPitch', 'headType', 'x', 'y', 'z', 'color', 'material'],
      category: 'fasteners'
    },
    'nut': {
      description: 'A nut fastener',
      properties: ['type', 'diameter', 'height', 'threadPitch', 'x', 'y', 'z', 'color', 'material'],
      category: 'fasteners'
    },
    'bolt': {
      description: 'A bolt fastener',
      properties: ['type', 'diameter', 'length', 'threadPitch', 'headType', 'x', 'y', 'z', 'color', 'material'],
      category: 'fasteners'
    },
    'washer': {
      description: 'A washer component',
      properties: ['type', 'innerDiameter', 'outerDiameter', 'thickness', 'x', 'y', 'z', 'color', 'material'],
      category: 'fasteners'
    },
    'rivet': {
      description: 'A rivet fastener',
      properties: ['diameter', 'length', 'headDiameter', 'x', 'y', 'z', 'color', 'material'],
      category: 'fasteners'
    },
    ...
    'wall': {
      ...
      properties: ['width', 'height', 'depth', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'floor': {
      description: 'A floor element',
      properties: ['width', 'length', 'thickness', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'roof': {
      description: 'A roof element',
      properties: ['width', 'length', 'height', 'style', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'window': {
      description: 'A window element',
      properties: ['width', 'height', 'depth', 'type', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'door': {
      description: 'A door element',
      properties: ['width', 'height', 'depth', 'type', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'stair': {
      description: 'A stair element',
      properties: ['width', 'height', 'length', 'steps', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    'column': {
      description: 'A column element',
      properties: ['diameter', 'height', 'style', 'x', 'y', 'z', 'color', 'material'],
      category: 'architectural'
    },
    ...
    'path3d': {
      description: '3D path',
      properties: ['points', 'width', 'x', 'y', 'z', 'color', 'material'],
      category: 'annotations'
    },
    'point-cloud': {
      description: 'A cloud of points in 3D space',
      properties: ['points', 'size', 'color', 'opacity'],
      category: 'data'
    },
    'mesh': {
      description: 'Custom 3D mesh',
      properties: ['vertices', 'faces', 'normals', 'x', 'y', 'z', 'color', 'material'],
      category: 'geometric'
    },
    'group': {
      description: 'A group of multiple elements',
      properties: ['children', 'x', 'y', 'z', 'name'],
      category: 'operations'
    },
    ...
    'tube': {
      description: 'A hollow cylinder',
      properties: ['outerRadius', 'innerRadius', 'height', 'x', 'y', 'z', 'color', 'material', 'wireframe'],
      category: 'mechanical'
    },
    'lathe': {
      description: 'A solid of revolution created by rotating a profile',
      properties: ['profile', 'segments', 'phiStart', 'phiLength', 'x', 'y', 'z', 'color', 'material'],
      category: 'operations'
    }
  };
} 